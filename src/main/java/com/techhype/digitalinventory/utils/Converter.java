...
public class Converter {
    ...
    public static String uni512zg1(String input_text) {
        ...
        output_text = output_text.replaceAll("(?<=[\\u100a\\u100c\\u1020\\u1025\\u1029][\\u102d\\u1036])\\u102f",
                "\u1033");
        ...
        output_text = output_text.replaceAll("(?<=[\\u103b\\u103c][\\u103d][\\u103e][\\u102d\\u1036])\\u1030",
                "\u1034");
        ...
        output_text = output_text.replaceAll("(?<=[\\u100a\\u100c\\u1020\\u1025\\u1029][\\u102d\\u1036])\\u1030",
                "\u1034");
        ...
        output_text = output_text.replaceAll(
                ...
                "\u1031$1$2$3");
        output_text = output_text.replaceAll(
                "([\\u1000-\\u1021\\u1029])((?:\\u1039[\\u1000-\\u1021\\u1000-\\u1021])?)(\\u103c)", "$3$1$2");
        output_text = output_text.replaceAll("\\u1004\\u103a\\u1039", "\u1064");
        output_text = output_text.replaceAll("(\\u1064)((?:\\u1031)?)((?:\\u103c)?)([\\u1000-\\u1021])\\u102d",
                "$2$3$4\u108b");
        output_text = output_text.replaceAll("(\\u1064)((?:\\u1031)?)((?:\\u103c)?)([\\u1000-\\u1021])\\u102e",
                "$2$3$4\u108c");
        output_text = output_text.replaceAll("(\\u1064)((?:\\u1031)?)((?:\\u103c)?)([\\u1000-\\u1021])\\u1036",
                "$2$3$4\u108d");
    ...
    public static class Option {
        ...
        public Option handleArguments(String argv[]) {
            ArgumentParser parser = ArgumentParsers.newArgumentParser("Converter").defaultHelp(true)
                    .description("Convert Zawgyi <-> Unicode encodings.");

            parser.addArgument("-t", "--to").choices("zawgyi", "unicode").required(true)
                    .help("Specify hash function to use");

            parser.addArgument("files").nargs("*").help("Files to convert");
